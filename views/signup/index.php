    ...
    <div class="row min-vh-100 d-flex">
        ...
        <div class="col-md-6 d-flex justify-content-center align-items-center">
            <div class=" bg-white p-4 rounded-3 shadow-sm">
                <h1 class="h3 mb-4 fw-normal text-center">¡Crear una cuenta!</h1>

                <p class="text-center mb-4">
                    ¿Ya tienes una cuenta? <a href="http://localhost/vega-distributions/views/login/" class="text-decoration-none">Conectarse</a>
                </p>
